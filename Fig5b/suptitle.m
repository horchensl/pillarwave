...
% axes(haold);                      % Change suggested by Rolf Bartstra: inactivating this line...
set(gcf,'CurrentAxes',haold);       % ... and introducing this one makes SUPTITLE compatible with the Matlab TITLE-command.   
